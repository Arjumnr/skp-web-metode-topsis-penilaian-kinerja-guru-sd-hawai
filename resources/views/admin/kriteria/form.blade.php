    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel1">Input Data Kriteria</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input type="text" id="kode" class="form-control" placeholder="ex : K1"
                                name="kode" />
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            <label for="pertanyaan" class="form-label">Pertanaan</label>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '.edit', function() {
                ...
                $.get("{{ route('kriteria') }}" + '/' + data_id + '/edit', function(data) {
